...
public class ParallelTestWithMultiThread {
    ...
    public void beforeMethos() throws MalformedURLException {
        ...
        capabilities.setCapability("PlatformName", "Windows10");
        ...
        ltOptions.put("user", "XXXXX_donzyk"); // System.getenv("LT_USERNAME"));
        ltOptions.put("accessKey", "XXXXXXXXXXXXXXXX"); // System.getenv("LT_ACCESS_KEY"));
